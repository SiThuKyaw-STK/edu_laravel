...
<nav class="navbar navbar-expand-lg bg-black ">
    <div class="container-fluid">
        <a class="navbar-brand text-primary" href="#"><h1 class="m-0">Education</h1></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 ">
                <li class="nav-item mx-2">
                    <h5 class="m-0"><a class="nav-link text-white text-uppercase" aria-current="page" href="#">Home</a></h5>
                </li>
                <li class="nav-item mx-2">
            ...
            <a href="#" class="btn btn-primary text-black text-uppercase fw-bolder">Login</a>
        </div>
    </div>
</nav>
